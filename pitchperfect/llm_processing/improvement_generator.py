...
class ImprovementGenerator:
    ...
    def generate_improvements(self,
                            ...
                            user_preferences: Optional[Dict] = None) -> ImprovementResult:
        """
        ...
        improved_text = self.text_improver.improve(
            text, issues, text_sentiment,
            preferences.get('target_style', 'professional')
        )

        # Step 3: Identify emphasis
        logger.info("Identifying emphasis words...")
        emphasis_words = self.emphasis_identifier.identify(improved_text, text_sentiment)
