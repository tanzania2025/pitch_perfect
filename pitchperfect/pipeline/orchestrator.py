...
class PipelineOrchestrator:
    ...
    def process(
        ...
        results = {"timestamp": datetime.now().isoformat(), "input_audio": audio_path}
        ...
        try:
            ...
            logger.info(
                f"Emotion: {sentiment['emotion']} ({sentiment['confidence']:.2f})"
            )
            ...
            try:
                ...
                results["synthesis"] = {"error": str(e), "status": "failed"}
